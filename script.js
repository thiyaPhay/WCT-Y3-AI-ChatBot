...
const GOOGLE_API_KEY = "AIzaSyCJEKZB5p93xaXNgrlUI0OVnWJ4tzcN5AU";
...
const loadSavedChatHistory = () => {
    ...
    savedConversations.forEach(conversation => {
        // Create the user's message HTML
        const userMessageHtml = `
            <div class="message__content">
                <img class="message__avatar" src="assets/vin.jpg" alt="User avatar">
        ...
        const responseHtml = `
            <div class="message__content">
                <img class="message__avatar" src="assets/vin.jpg" alt="Gemini avatar">
...
const handleOutgoingMessage = () => {
    ...
    const outgoingMessageHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="assets/chea.jpg" alt="User avatar">
            <p class="message__text"></p>
        </div>
...
// Prevent default from submission and handle outgoing messages 
